...
namespace ET
{
	public static class Define
	{
		...
		{
#if UNITY_EDITOR
			Debug.Log("GetAssetPathsFromAssetBundle-assetBundleName:" + assetBundleName);
			string[] assBundle = UnityEditor.AssetDatabase.GetAssetPathsFromAssetBundle(assetBundleName);
			return assBundle;
            //return UnityEditor.AssetDatabase.GetAssetPathsFromAssetBundle(assetBundleName);
            //return new string[0];
#else
			Debug.Log("GetAssetPathsFromAssetBundle2222-assetBundleName:" + assetBundleName);
			return new string[0];
#endif
        }
